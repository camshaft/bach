...
pub trait QueueExt<T>: 'static + Queue<T> + Sized {
    #[inline]
...
impl<Q, T> QueueExt<T> for Q where Q: 'static + Queue<T> + Sized {}

pub trait InstantQueueExt<T>: 'static + Queue<(Instant, T)> + Sized {
    #[inline]
...
impl<Q, T> InstantQueueExt<T> for Q where Q: 'static + Queue<(Instant, T)> + Sized {}
